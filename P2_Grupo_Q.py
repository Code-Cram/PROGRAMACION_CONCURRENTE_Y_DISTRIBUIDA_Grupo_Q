...
# ── Modificación de Calle para soportar modo distribuido ─────
...
# ── Modificación de Barrio para soportar modo distribuido ────
# añadir_calle() acepta ahora un nombre de calle remota (str)
# además del objeto Calle local. En modo distribuido, la lógica
# del barrio usa Proxies en lugar de referencias directas.
...
# ── BarrioComercial distribuido ───────────────────────────────
# Sobreescribimos _redistribuir_recursos para que use los
# métodos abstractos de acceso (_get_inventario_calle, etc.)
# en lugar de acceder directamente a calle.inventario.
...
# ── BarrioEconomico distribuido ───────────────────────────────
# Sobreescribimos _ajustar_precios para modo distribuido.
# En remoto, ajustamos precios usando get_jugadores_info()
# para leer el estado y fijar_precio() en cada calle local
...
# ── Actualización del MUD para Semana 3 ──────────────────────
