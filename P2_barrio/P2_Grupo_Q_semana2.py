...
if __name__ == "__main__":
    ...
    recetas_herrero = [
        {"produce": "esclavo",       "cantidad": 1, "necesita": {}, "tiempo": 1},
        {"produce": "herramientas", "cantidad": 1, "necesita": {"esclavo": 1},  "tiempo": 6},
    ]
    t_minero  = Trabajador(recetas_minero,  {}, Lock(), {"mineral": 2})
    t_herrero = Trabajador(recetas_herrero, {}, Lock(), {"esclavo": 8, "herramientas": 15})
    Pablo    = Jugador("Pablo",    t_minero,  monedas=50)
    Alejandro = Jugador("Alejandro", t_herrero, monedas=50)
    calle_hierro = Calle("Calle del Hierro")
    calle_hierro.añadir_jugador(Pablo)
    calle_hierro.añadir_jugador(Alejandro)
